...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Verifica se a função `getCharacter` o objeto correto para o parâmetro Arya.', () => {
    expect(getCharacter('Arya')).toEqual({
      name: 'Arya Stark',
      class: 'Rogue',
      phrases: ['Not today', 'A girl has no name.']
  ...
  it('Verifica se a função `getCharacter` o objeto correto para o parâmetro Brienne.', () => {
  ...
  it('Verifica se a função `getCharacter` o objeto correto para o parâmetro Melissandre.', () => {
  ...
  it('Verifica se a função `getCharacter` não é Case Sensitive, ou seja, independente de conter letras maiúsculas ou minúsculas retorna o mesmo objeto relativo a ele.', () => {
    expect(getCharacter('briEnNe')).toEqual({
      name: 'Brienne Tarth',
      class: 'Knight',
      phrases: ['Im No Lady, Your Grace.', 'I, Brienne Of Tarth, Sentence You To Die.']
  ...
  it('Verifica se ao passar um nome que não está na tabela, a função retorna undefined.', () => {
    expect(getCharacter('Thiago')).toBeUndefined();
